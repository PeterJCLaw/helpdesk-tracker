...
DATABASE_NAME = os.path.abspath('db.sqlite')             # Or path to database file if using sqlite3.
...
SECRET_KEY = 'd-j4gbyja5inml^!7v==hicc-3k(lzu-*6tt#+_g1@e8gy-6bb'
...
ROOT_URLCONF = 'helpdesk-tracker.urls'
